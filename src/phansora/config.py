"""Platform-level configuration for the Phansora API.
...
module under ``phansora.products.<name>`` — this file never imports those, to
...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        return cls(
            app_name=os.getenv("PHANSORA_APP_NAME", "Phansora API"),
            version=os.getenv("PHANSORA_VERSION", "0.1.0"),
