...
A single backend that hosts multiple AI products under one package:
    ...
    phansora.products.spokenverse    — PDF/OCR, text->audio (CosyVoice2), Book Alchemy
    phansora.products.chrono_origin  — trace the origin of a story/myth (GPT-5 Nano grounded search)
